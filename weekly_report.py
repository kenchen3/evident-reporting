...
public = credentials.get_public()
secret = credentials.get_secret()

# Email
emails = credentials.get_email_address()
gmail_user = credentials.get_email_address() # e.g my_account@gmail.com
gmail_password = credentials.get_email_password() # recommend using app password
